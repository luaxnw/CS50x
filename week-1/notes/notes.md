...
1. \r - Retorno de Carro: move o cursos para o início da linha atual, permite sobrescrever o texto anterior.
2. \" e \' e \ \ - Citação: usado quando precisamos utilizar aspas simples, aspas dupla ou barras.
